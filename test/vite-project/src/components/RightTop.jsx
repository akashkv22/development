    ...
    return(
        <>
         <div className="right-top-div">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="18px" width="20px" viewBox="0 0 512 512" style={{
              marginBottom: "5px"
            ...
            <p style={{marginTop :"10px",marginRight:"15px",fontSize : "17px"}}>&nbsp;Richard John</p>
          </div>
